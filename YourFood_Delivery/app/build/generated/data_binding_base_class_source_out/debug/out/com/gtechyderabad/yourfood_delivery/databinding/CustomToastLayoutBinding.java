...
public final class CustomToastLayoutBinding implements ViewBinding {
  ...
  private CustomToastLayoutBinding(@NonNull LinearLayout rootView, @NonNull TextView toastMessage) {
  ...
  public static CustomToastLayoutBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new CustomToastLayoutBinding((LinearLayout) rootView, toastMessage);
    }
