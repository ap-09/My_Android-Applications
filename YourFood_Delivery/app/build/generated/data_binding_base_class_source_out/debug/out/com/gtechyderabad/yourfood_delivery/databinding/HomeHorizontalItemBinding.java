...
public final class HomeHorizontalItemBinding implements ViewBinding {
  ...
  @NonNull
  public final ImageView imgPizza;

  @NonNull
  public final TextView txtPizza;

  private HomeHorizontalItemBinding(@NonNull CardView rootView, @NonNull CardView cardView,
      @NonNull ImageView imgPizza, @NonNull TextView txtPizza) {
  ...
  public static HomeHorizontalItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.img_pizza;
      ImageView imgPizza = ViewBindings.findChildViewById(rootView, id);
      if (imgPizza == null) {
        break missingId;
      }

      id = R.id.txt_pizza;
      TextView txtPizza = ViewBindings.findChildViewById(rootView, id);
      if (txtPizza == null) {
        break missingId;
      }

      return new HomeHorizontalItemBinding((CardView) rootView, cardView, imgPizza, txtPizza);
    }
